...
5. in nLen = MultiByteToWideChar(CP_ACP, 0, pmb, mLen, NULL, 0);
...
25. intutf8Len = WideCharToMultiByte(CP_UTF8, 0, lpszW, nLen, NULL, 0,
...
31. ntn = WideCharToMultiByte(CP_UTF8, 0, lpszW, nLen, &\*pu8.begin(),
...
46. int nLen = MutiByteToWideChar(CP_UTF8, 0, pu8, utf8Len, NULL, 0);
...
51. lszW = new WCHAR\[nLen\];

52. }

53. catch(bad_allc &memExp)
...
58. int nRtn = MuliByteToWideChar(CP_UTF8, 0, pu8, utf8Len, lpszW,
...
73. Rtn = WideCharToMultiByte(CP_ACP, 0, lpszW, nLen, &\*pmb.begin(),
