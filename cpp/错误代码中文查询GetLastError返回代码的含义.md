...
字符域与软盘控制器磁道\
地址不相符。 〖1124〗-软盘控制器报告软盘驱动程序不能识别的错误。
〖1125〗-软盘控制器返回\
与其寄存器中不一致的结果。
...
〖1720〗-无法创建终结点。\
〖1721〗-资源不足，无法完成此操作。 〖1722〗-RPC 服务器不可用。
〖1723〗-RPC 服务器过忙\
...
〖1769〗-RPC 服\
务器上的浮点操作导至以零做除数。 〖1770〗-RPC 服务器上发生浮点下溢。
〖1771〗-RPC 服务器\
...
存在。 〖2102〗-没有安装工作站驱动程序。 〖2103〗-无法定位服务器。
〖2104〗-发生内部错\
...
〖2275〗-已经添\
加了此消息别名，但是仍被转发。 〖2276〗-此消息别名已在本地存在。
〖2277〗-添加的消息别名\
