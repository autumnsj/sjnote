...
## [#](https://cloud.iocoder.cn/module-new/#_2-新建-demo-api-子模块)2. 新建 demo-api 子模块

① 新建 `yudao-module-demo-api` 子模块，整个过程和“新建 demo 模块”是一致的，如下图所示：

![打开 New Module](新建服务.assets/40.png)

![填写 Module 信息](新建服务.assets/42-api.png)
...
![新建基础包](新建服务.assets/44.png)

## [#](https://cloud.iocoder.cn/module-new/#_3-新建-demo-biz-子模块)3. 新建 demo-biz 子模块

① 新建 `yudao-module-demo-biz` 子模块，整个过程和“新建 demo 模块”也是一致的，如下图所示：

![打开 New Module](新建服务.assets/40.png)

![填写 Module 信息](新建服务.assets/42-biz.png)
...
![刷新 Maven 依赖](新建服务.assets/46.png)

⑤ 在 `resources` 目录下，新建配置文件。如下图所示：

![配置文件](新建服务.assets/101.png)
...
## [#](https://cloud.iocoder.cn/module-new/#_4-新建-restful-api-接口)4. 新建 RESTful API 接口
...
## [#](https://cloud.iocoder.cn/module-new/#_5-启动-demo-服务)5. 启动 demo 服务
...
![测试  接口](新建服务.assets/48.png)

④ 打开“用户 App - Test”接口，进行 `/app-api/demo/test/get` 接口的调试，如下图所示：

![测试  接口](新建服务.assets/49.png)

## [#](https://cloud.iocoder.cn/module-new/#_6-网关配置)6. 网关配置

① 打开 `yudao-gateway` 网关项目的 `application.yml` 配置文件，增加 `demo` 服务的路由配置。代码如下：

![网关路由配置](新建服务.assets/102.png)
...
```yaml
        - id: demo-admin-api # 路由的编号
          ...
          predicates: # 断言，作为路由的匹配条件，对应 RouteDefinition 数组
            - Path=/admin-api/demo/**
          filters:
            - RewritePath=/admin-api/demo/v2/api-docs, /v2/api-docs # 配置，保证转发到 /v2/api-docs
        - id: demo-app-api # 路由的编号
          uri: grayLb://demo-server
          predicates: # 断言，作为路由的匹配条件，对应 RouteDefinition 数组
            - Path=/app-api/demo/**
          filters:
            - RewritePath=/app-api/demo/v2/api-docs, /v2/api-docs
      - name: demo-server
...
![网关 Swagger 接口文档](新建服务.assets/103-1690791744821-15.png)
